...
\usepackage{xcolor}
\definecolor{Peach}{HTML}{ffe7d4}
% \definecolor{slate}{HTML}{494e5f}
...
\renewcommand*{\cvsection}[1]{%
  \vspace{3pt}
  \begin{tikzpicture}
    \node[fill=Peach, text width=\linewidth, rounded corners=3pt, inner sep=5pt] {\color{slate}\normalfont\bfseries\LARGE #1};
  \end{tikzpicture}
  \vspace{8pt}
}
...
\addtofrontsidebar{
  ...
  \skill{\faLightbulb}{Knowledge-Driven and seeking In-
    novation}
  ...
  \begin{sidebarminipage}
    \begin{center}
      ...
      \chartlabel{Docker}
      \chartlabel{Streamlit/Dash}
      \chartlabel{Linux}
      \chartlabel{Ansible}
      \chartlabel{CI/CD}
      \chartlabel{Prometheus stack}
    \end{center}
  \end{sidebarminipage}
  ...
  \begin{icontable}{2.5em}{1em}
    \social{\faLinkedin}
    {https://www.linkedin.com/in/jakobaaes}{linkedin.com/in/jakobaaes}
    \social{\faGithub}
    {https://github.com/jakob1379/}
    {github.com/jakob1379/}
  \end{icontable}

  \sidesection{Contact}
  \begin{icontable}{2.5em}{1em}
    \personal{\faBirthdayCake}{July $24^{th}$, 1993}
    \personal{\faMapMarker}{\href{https://www.google.com/maps/place/2400+København+NV}{København NV}}
    \personal{\faPhone}{\href{tel:+4593978373}{+45 93 97 83 73}}
    \personal{\faEnvelope}{\href{mailto:jakob1379@gmail.com}{jakob1379@gmail.com}}
  \end{icontable}
...
\begin{cvtable}[1.5]
	\cvitem{2009 -- 2010}{Post-Doc Panda Studies}{Panda Academyx}
